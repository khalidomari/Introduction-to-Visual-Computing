...
public class QuadGraph {
	...
	public PVector[] getPVector(int i) {
		PVector l1 = game.linesList.get(cycles.get(i)[0]);
		PVector l2 = game.linesList.get(cycles.get(i)[1]);
		PVector l3 = game.linesList.get(cycles.get(i)[2]);
		PVector l4 = game.linesList.get(cycles.get(i)[3]);

		PVector c12 = game.intersection(l1, l2);
		PVector c23 = game.intersection(l2, l3);
		PVector c34 = game.intersection(l3, l4);
		PVector c41 = game.intersection(l4, l1);
